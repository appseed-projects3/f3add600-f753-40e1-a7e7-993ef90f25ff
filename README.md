...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-04 09:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f3add600-f753-40e1-a7e7-993ef90f25ff.git
$ cd f3add600-f753-40e1-a7e7-993ef90f25ff
```
